/**
 * Fundamentos POO
 * Abstração, Herança e Poliformismo
 * @author Alex Lima
 */
...
class Bloco{
    //atribuitos
    constructor(textura, resitencia) {
...
class Enxada extends Bloco {
    ...
    criarEnxada() {
        ...
        console.log(`Resistencia: ${this.resitencia}`)
    }
    arar() {
        console.log("._._._.")
    ...
    //Polimorfismo: Mudança de comportamento de um Método que existe na classe pai(modelo) no exemplo Bloco
    //Atenção !!! Obrigatoriousar o mesmo nome do método
    minerar() {
